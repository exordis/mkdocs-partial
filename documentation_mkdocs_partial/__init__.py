...
from documentation_mkdocs_partial.mkdcos_helpers import replace_mkdocs_plugin_entrypoint
...
SPELLCHECK_ENTRYPOINT_SHIM = "documentation_mkdocs_partial.integrations.spellcheck_plugin_shim:SpellCheckShim"
...
MACROS_ENTRYPOINT_SHIM = "documentation_mkdocs_partial.integrations.macros_plugin_shim:MacrosPluginShim"

REDIRECTS_ENTRYPOINT_NAME = "redirects"
REDIRECTS_ENTRYPOINT_VALUE = "mkdocs_redirects.plugin:RedirectPlugin"
REDIRECTS_ENTRYPOINT_SHIM = "documentation_mkdocs_partial.integrations.redirect_plugin_shim:RedirectPluginShim"
